    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipePlanning", x => new { x.RecipeId, x.PlanningId, x.MealId });
                    table.ForeignKey(
                        name: "FK_RecipePlanning_Meal_MealId",
                        column: x => x.MealId,
                        principalTable: "Meal",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecipePlanning_Planning_PlanningId",
                        column: x => x.PlanningId,
                        principalTable: "Planning",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecipePlanning_Recipe_RecipeId",
                        column: x => x.RecipeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipePlanning_MealId",
                table: "RecipePlanning",
                column: "MealId");

            migrationBuilder.CreateIndex(
                name: "IX_RecipePlanning_PlanningId",
                table: "RecipePlanning",
                column: "PlanningId");
        }
